                ...
                <div className="relative">
                    ...
                    >
                        {experience.items.map((job, index) => (
                            ...
                            >
                                {/* Timeline Dot */}
                                <div className="absolute left-6 top-8 w-5 h-5 bg-white dark:bg-gray-900 border-4 border-purple-500 rounded-full z-10 hidden md:block">
                                    <div className="absolute inset-1 bg-purple-500 rounded-full"></div>
                                </div>

                                {/* Content Card */}
                                <div className="md:ml-20 bg-white dark:bg-gray-800 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden">
                                    <div className="p-8">
                                                    ...
                                                    <ul className="space-y-3">
                                                        {job.description.map((point, pointIndex) => (
                                                            <li key={pointIndex} className="flex items-start gap-3">
                                                                ...
                                                                <span className="text-gray-700 dark:text-gray-400 leading-relaxed">{point}</span>
                                                            </li>
                                                        ))}
                                                    </ul>
                                                </div>
