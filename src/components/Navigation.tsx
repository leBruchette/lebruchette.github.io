        ...
        <>
            ...
            <motion.nav
                ...
                className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
                    isScrolled
                        ? 'bg-white/90 dark:bg-gray-900 backdrop-blur-md shadow-lg'
                        : 'bg-transparent'
                }`}
            >
                        ...
                        <AnimatePresence mode="wait">
                            <motion.span
                                ...
                                className={`font-bold text-xl transition-colors duration-300 ${
                                    isScrolled ? 'text-gray-600 dark:text-gray-200' : 'text-white'
                                }`}
                                    ...
                                    className={`relative px-3 py-2 text-sm font-medium transition-colors duration-300 hover:scale-105 ${
                                        activeSection === item.href.slice(1)
                                            ? isScrolled
                                                ...
                                                : 'text-white'
                                            : isScrolled
                                                ? 'text-gray-600 dark:text-gray-200 hover:text-purple-600'
